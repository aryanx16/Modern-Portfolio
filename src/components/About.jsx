                    ...
                    <div className='flex justify-between '>
                        <div className='w-100 text-neutral-500'>
                            ...
                            <div className='flex gap-1 mt-1'>
                                <a href="" className=' border p-1 rounded-md dark:border-neutral-500 dark:hover:text-neutral-400 border-neutral-300 hover:text-neutral-700 dark:hover:bg-neutral-800 hover:bg-neutral-200 '>
